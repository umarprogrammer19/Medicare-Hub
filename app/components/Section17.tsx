...
export default function StatsSection() {
  return (
    <>
      ...
      <section className="font-[Poppins] bg-[#050b1f] text-white py-24">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">

          {/* LEFT IMAGE */}
          <div>
            <Image
              src="/dr.png"   // apni image public folder mein rakho
              alt="Doctor"
              width={500}
              height={600}
...
function StatBox({ number, title, text }) {
  return (
    <div>
      ...
      <h4 className="text-xl font-semibold tracking-wide mb-3 relative inline-block">
        {title}
