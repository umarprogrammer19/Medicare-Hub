    ...
    <section className={`py-20 ${poppins.className}`}>
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x">
        <div className="group flex flex-col items-center text-center px-6 py-10">
          <div className="w-20 h-20 rounded-full bg-[#243567] flex items-center justify-center text-white 
          text-3xl mb-6 border-2 border-transparent transition-all duration-300 group-hover:bg-white 
          group-hover:border-[#243567] group-hover:text-[#243567] cursor-pointer">
            <FiMapPin />
          </div>
        ...
        <div className="group flex flex-col items-center text-center px-6 py-10">
          <div className="w-20 h-20 rounded-full bg-[#243567] flex items-center justify-center text-white 
          text-3xl mb-6 border-2 border-transparent transition-all duration-300 group-hover:bg-white group-hover:border-[#243567]
            group-hover:text-[#243567] cursor-pointer">
            <FiCalendar />
          </div>
